...
namespace NintendoSpy
{
    ...
    public class SerialMonitor
    {
        ...
        public SerialMonitor(string portName)
        {
            ...
            _datPort = new SerialPort(portName);
            _datPort.BaudRate = BAUD_RATE;
            _datPort.DtrEnable = true;
            _datPort.RtsEnable = true;
            _datPort.DataBits = 8;
            _datPort.StopBits = StopBits.One;
            _datPort.Parity = Parity.None;
            _datPort.Handshake = Handshake.None;
        }
